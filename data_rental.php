            ...
            <button class="navbar-toggler navbar-toggler-right d-lg-none align-self-center" type="button" data-toggle="offcanvas">
              <span class="mdi mdi-menu"></span>
               ...
               <div class="container-fluid">
                        ...
                        <div class="card mb-4">
                            <div class="card-header"><i class="fas fa-table mr-1"></i>DATA RENTAL</div>
                            <div class="card-body">
                                <div class="table-responsive">
                                <a href="data_rental_add.php" class="btn btn-primary">Tambah Data</a><p></p>
                                    ...
                                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                        ...
                                        include"koneksi.php";
                                        $no=1;
                                        $sql = mysqli_query($con, "select * from tbl_rental");
                                        while($row = mysqli_fetch_array($sql)){
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo"$row[mulai_rntl]"; ?></td>
                                                 <td><?php echo"$row[pengembalian]"; ?></td>
                                                 <td><?php echo"$row[total]"; ?></td>
                                                 <td><?php echo"$row[status]"; ?></td>
                                              
                                                   <td>
                                                    <a href="<?php echo"index.php?page=data_rental_edit&&id=$row[id_rental]" ?>" class="btn btn-warning">EDIT</a>

                                                        <a href="<?php echo"index.php?page=data_rental_delete&&id=$row[id_rental]" ?>" class="btn btn-danger" onclick="javascript: retrun confirm('apakah anda yakin ingin menghapus data ini...?')">Hapus</a>
                                                    </td>
                                                   </tr>
