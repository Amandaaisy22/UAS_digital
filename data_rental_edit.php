...
<?php
include"koneksi.php";
$sql= mysqli_query($con,"select * from tbl_rental where id_rental =$_GET[id] ");
...
<form method="POST" enctype="multipart/form-data">
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input type="text" name="mulai_rntl" class="form-control" value="<?php echo"
                $row[mulai_rntl]"; ?>">
            </div>
             </div>
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input type="text" name="pengembalian" class="form-control" value="<?php echo"
                $row[pengembalian]"; ?>">
            </div>
             </div>
             <div class="col-md-6">
            <div class="form-group">
                <label>Total :</label>
                <input type="text" name="total" class="form-control" value="<?php echo"
                $row[total]"; ?>">
            </div>
             </div>
        <div class="col-md-6">
...
if ($_SERVER['REQUEST_METHOD']=="POST"){
    ...
    $query = mysqli_query($con,"update tbl_rental set mulai_rntl='$_POST[mulai_rntl]', pengembalian='$_POST[pengembalian]', total='$_POST[total]', status='$_POST[status]'  where id_rental = $_GET[id] ");
