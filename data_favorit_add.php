...
<form method="POST" enctype="multipart/form-data">
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input type="text" name="id_produk" class="form-control" placeholder="Masukkan ID Produk">
            </div>
        </div>
    </div>
   ...
   <center>
        <div class="form-group mt-4 mb-0">
            <input type="submit" name="proses" class="btn btn-primary" value="Simpan Data Favorit">
...
if($_SERVER['REQUEST_METHOD']=="POST"){
    include"koneksi.php";
    $query = mysqli_query($con,"insert into tbl_favorit(id_produk, nm_brng, brand ) value('$_POST[id_produk]','$_POST[nm_brng]','$_POST[brand]')");
