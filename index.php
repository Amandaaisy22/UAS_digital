    ...
    <div class="container-scroller">
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        ...
        <ul class="nav">
          ...
          <li class="nav-item">
            <a class="nav-link" data-toggle="collapse" href="data_user.php" aria-expanded="false" aria-controls="ui-basic">
            ...
            <a class="nav-link" data-toggle="collapse" href="data_rental.php" aria-expanded="false" aria-controls="ui-basic">
              <i class="mdi mdi-crosshairs-gps menu-icon"></i>
              <span class="menu-title">Data Rental</span>
            </a>
             <li class="nav-item">
            ...
            <a class="nav-link" data-toggle="collapse" href="data_favorit.php" aria-expanded="false" aria-controls="ui-basic">
              <i class="mdi mdi-crosshairs-gps menu-icon"></i>
              <span class="menu-title">Data Favorit</span>
            </a>
        ...
        <div class="main-panel">
          <div class="content-wrapper pb-0">
            <div class="page-header flex-wrap">
              <h3 class="mb-0"> Hi, welcome Back! <span class="pl-0 h6 pl-sm-2 text-muted d-inline-block">Welcome To Luxrent</span>
              </h3>
               ...
               <main>
                ...
                if(isset($_GET['page'])){
                    ...
                    switch ($page) {
                        ...
                        case 'data_rental_edit':
                        include "data_rental_edit.php";
                        break;
                        
                        case 'data_favorit_edit':
                          include "data_favorit_edit.php";
                          break;
                          case 'data_user_delete':
                            include "data_user_delete.php";
                            break;
                            case 'data_rental_delete':
                              include "data_rental_delete.php";
                              break;

                              case 'data_produk_delete':
                                include "data_produk_delete.php";
                                break;
                                case 'data_favorit_delete':
                                  include "data_favorit_delete.php";
                                  break;
          ...
          <footer class="footer">
            <div class="d-sm-flex justify-content-center justify-content-sm-between">
              <span class="text-muted d-block text-center text-sm-left d-sm-inline-block">Copyright © Amanda, Dion, Nadya</span>
              <span class="float-none float-sm-right d-block mt-1 mt-sm-0 text-center"><a href="https://www.bootstrapdash.com/" target="_blank">LUXRENT</a>
            </div>
          </footer>
        </div>
        <!-- main-panel ends -->
