            ...
            <button class="navbar-toggler navbar-toggler-right d-lg-none align-self-center" type="button" data-toggle="offcanvas">
              <span class="mdi mdi-menu"></span>
               ...
               <div class="container-fluid">
                        ...
                        <div class="card mb-4">
                            <div class="card-header"><i class="fas fa-table mr-1"></i>DATA FAVORIT</div>
                            <div class="card-body">
                                <div class="table-responsive">
                                <a href="data_favorit_add.php" class="btn btn-primary">Tambah Data</a><p></p>
                                    ...
                                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                        ...
                                        include"koneksi.php";
                                        $no=1;
                                        $sql = mysqli_query($con, "select * from tbl_favorit");
                                        while($row = mysqli_fetch_array($sql)){
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo"$row[brand]"; ?></td>
                                                   ...
                                                   <td>
                                                    <a href="<?php echo"index.php?page=data_favorit_edit&&id=$row[id_produk]" ?>" class="btn btn-warning">EDIT</a>

                                                        <a href="<?php echo"index.php?page=data_favorit_delete&&id=$row[id_produk]"?>" class="btn btn-danger" onclick="javascript: retrun confirm('apakah anda yakin ingin menghapus data ini...?')">Hapus</a>
                                                    </td>
                                                   </tr>
