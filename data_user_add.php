...
<div class="card mb-4">
<div class="card-header"><i class="fas fa-edit mr-1"></i>Data User</div>
<div class="card-body">
...
<div class="form-row">
        ...
        <div class="form-group mt-4 mb-0">
            <input type="submit" name="proses" class="btn btn-primary" value="Simpan Data Customer">
...
if($_SERVER['REQUEST_METHOD']=="POST"){
    include"koneksi.php";
    $query = mysqli_query($con,"insert into tbl_users(id_user, name, email, password, alamat) value('$_POST[id_user]','$_POST[name]','$_POST[email]','$_POST[password]','$_POST[alamat]')");
