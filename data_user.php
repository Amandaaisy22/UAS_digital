               ...
               <div class="container-fluid">
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                ...
                                <a href="data_user_add.php" class="btn btn-primary">Tambah Data</a><p></p>
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo"$row[name]"; ?></td>
                                                 ...
                                                 <td><?php echo"$row[alamat]"; ?></td>
                                                   ...
                                                   <td>
                                                    <a href="<?php echo"index.php?page=data_user_edit&&id=$row[id_user]" ?>" class="btn btn-warning">EDIT</a>

                                                        <a href="<?php echo"index.php?page=data_user_delete&&id=$row[id_user]" ?>" class="btn btn-danger" onclick="javascript: retrun confirm('apakah anda yakin ingin menghapus data ini...?')">Hapus</a>
                                                    </td>
                                                   </tr>
