               ...
               <div class="container-fluid">
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                ...
                                <a href="data_produk_add.php" class="btn btn-primary">Tambah Data</a><p></p>
                                    ...
                                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                        ...
                                        while($row = mysqli_fetch_array($sql)){
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo"$row[nm_brng]"; ?></td>
                                                 <td><?php echo"$row[brand]"; ?></td>
                                                 <td><?php echo"$row[harga_perhari]"; ?></td>
                                                 
                                              
                                                   <td>
                                                    <a href="<?php echo"index.php?page=data_produk_edit&&id=$row[id_produk]" ?>" class="btn btn-warning">EDIT</a>

                                                        <a href="<?php echo"index.php?page=data_produk_delete&&id=$row[id_produk]" ?>" class="btn btn-danger" onclick="javascript: retrun confirm('apakah anda yakin ingin menghapus data ini...?')">Hapus</a>
                                                    </td>
                                                   </tr>
